            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center my-10 lg:my-20 bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text">
                ...
                <div className="flex flex-wrap justify-center">
                  {testimonials.map((testimonial, index) => (
                        <div key={index} className="w-full sm:w-1/2 lg:w-1/3 pc-4 py-2">
                            <div className="bg-neutral rounded-md p-6 text-md border border-neutral-800 font-thin">
                                ...
                                <div className="flex mt-8 items-start">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-white test-sm font-normal italic text-neutral-600">{testimonial.company}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
